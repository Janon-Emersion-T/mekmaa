...
func main() {
	...
	mux.Handle("/admin/games/update", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.updateGameHandler), "space_bookings.manage")))
	mux.Handle("/admin/games/delete", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.deleteGameHandler), "space_bookings.manage")))
	mux.Handle("/admin/one-to-one", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.oneToOneManagementHandler), "space_bookings.manage")))
	mux.Handle("/admin/one-to-one/create", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.createOneToOneOfferingHandler), "space_bookings.manage")))
	mux.Handle("/admin/one-to-one/update", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.updateOneToOneOfferingHandler), "space_bookings.manage")))
	mux.Handle("/admin/one-to-one/delete", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.deleteOneToOneOfferingHandler), "space_bookings.manage")))
	mux.Handle("/admin/one-to-one-bookings", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.oneToOneBookingManagementHandler), "space_bookings.manage")))
	mux.Handle("/admin/one-to-one-bookings/create", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.createOneToOneBookingHandler), "space_bookings.manage")))
	mux.Handle("/admin/one-to-one-bookings/delete", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.deleteOneToOneBookingHandler), "space_bookings.manage")))
