...
func main() {
	...
	mux.Handle("/admin/students/status", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.updateStudentStatusHandler), "admissions.update")))
	...
	mux.Handle("/admin/payroll/generate-staff", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.generateStaffPayrollHandler), "payroll.create")))
	...
	mux.Handle("/admin/payroll/recalculate", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.recalculatePayrollRunHandler), "payroll.update")))
	...
	mux.Handle("/admin/payroll/payment/approve", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.approvePayrollPaymentHandler), "payroll.update")))
	mux.Handle("/admin/payroll/payment/rollback", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.rollbackPayrollPaymentApprovalHandler), "payroll.update")))
	...
	mux.Handle("/admin/payroll/student-report", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.payrollStudentReportHandler), "payroll.view")))
	...
	mux.Handle("/admin/staff/advances", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.staffAdvanceManagementHandler), "payroll.view")))
	mux.Handle("/admin/staff/advances/create", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.createStaffAdvanceHandler), "payroll.create")))
	mux.Handle("/admin/staff/advances/repayment", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.collectStaffAdvanceRepaymentHandler), "payroll.update")))
	...
	mux.Handle("/admin/student-groups/occurrences/save", app.sessionMiddleware(app.requirePermission(http.HandlerFunc(app.saveStudentGroupSessionOccurrenceHandler), "student_groups.update")))
	...
	mux.Handle("/admin/tournaments/finance/void", app.sessionMiddleware(app.requireSportsOperationalAccess(app.requirePermission(http.HandlerFunc(app.voidTournamentFinanceRecordHandler), "finance_transactions.delete"))))
	...
	mux.Handle("/admin/mcp-receivables/payments/void", app.sessionMiddleware(app.requireSportsOperationalAccess(app.requirePermission(http.HandlerFunc(app.voidMCPPaymentHandler), "finance_transactions.delete"))))
